(() => {
  ...
  const PHOTOS = [
    { file: '01', x: 160, y: 175, pin: 'o jantar',
      title: 'Aquele jantar',
      text: 'Você apoiada na mão, me olhando desse jeito. Eu não lembro o que a gente comeu. Lembro disso.' },
    ...
    { file: '04', x: 825, y: 150, pin: 'Limeira',
      title: 'Limeira · o túnel azul',
      text: 'Nossa viagem pra Limeira. Um corredor de luz e você do meu lado — meu lugar preferido no mundo.' },
    { file: '05', x: 820, y: 320, pin: 'nós dois',
      title: 'Limeira · nós dois',
      text: 'Ainda em Limeira. Esse sorriso é o motivo de eu levantar todo dia.' },
    { file: '06', x: 605, y: 400, pin: 'eu, sério',
      title: 'Limeira · eu, sendo eu',
      text: 'Prova de que você namora um homem muito sério. Você ri dessa foto até hoje, e eu amo isso.' },
    { file: '07', x: 395, y: 470, pin: 'a gente',
      title: 'Nossa cara de sempre',
      text: 'Você mostrando a língua, eu fingindo que não te conheço. Nosso retrato mais fiel.' },
  ].map((p) => ({
    ...p,
